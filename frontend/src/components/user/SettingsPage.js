// frontend/src/components/user/SettingsPage.js
...
const SettingsPage = ({ user, onChangePassword, onUpdateSettings }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-xl font-bold text-[#2A3190] flex items-center gap-3">
        ...
        <div className="lg:col-span-3">
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            {activeTab === 'notifications' && (
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-6">Preferencias de Notificaciones</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      <h4 className="font-medium text-gray-800">Emails de Marketing</h4>
            ...
            {activeTab === 'security' && (
              <div>
                <h3 className="text-lg font-semibold text-gray-800 mb-6">Configuración de Seguridad</h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <h4 className="font-medium text-gray-800 mb-3">Información de Sesión</h4>
